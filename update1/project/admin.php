		...
		<ul class="side-menu top">
			...
			<li>
				<a href="job_management.php">
					...
					<span class="text">Job management</span>
				</a>
			</li>
			<li>
				<a href="post.php">
					<i class='bx bxs-group' ></i>
					<span class="text">all candidates</span>
				</a>
			</li>
			<li>
				<a href="#">
					<i class='bx bxs-group' ></i>
					<span class="text">All employers</span>
				</a>
			</li>
			<li>
				<a href="#">
