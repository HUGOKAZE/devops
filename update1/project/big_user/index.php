...
<body>
    ...
    <div class="div2">
      <div class="ma">
         <div><h2 class="se">list of Employer</h2> <p class="nb"> nbre d'Employer</p></div>
         <div class="pa" >
                <div>
        ...
        <table class="" cellspacing="0">
          ...
          <tbody>
            <?php 
             ...
             $sql="SELECT * FROM user where role='employer'";
            ...
            <tr class="<?php echo $rowClass; ?>">
              <td class="su"><?php echo$row['user_id']?></td>
              ...
              <td class="action">
                <a href="deletteEmp.php?id=<?php echo$row['user_id']?>" onclick="return confirm("voulez vous vraiment supprimez?")">
