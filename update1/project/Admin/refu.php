...
$row1 = mysqli_fetch_assoc($result1);
    if ($row && $row1 ) {
        ...
        $sqlUpdate = "UPDATE job_application SET statut = 2 WHERE application_id = $id";
        if (mysqli_query($conn, $sqlUpdate)) {
            ...
            try {
                ...
                $mail->Body    = "<h1>Bonjour $nom,</h1><p>Votre candidature a été refusee par l'entreprise $employname pour le poste $title .</p>";
                $mail->AltBody = "Bonjour $nom, Votre candidature a été refusee par l'entreprise $employname pour le poste $title .";
