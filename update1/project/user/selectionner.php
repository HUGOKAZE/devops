...
<div class="nav">
        ...
        <h1 class=" text-white name"><?php echo$nom;?></h1>
         <div class="tre">
            ...
            <div class="perspar">
            <a href="index.php" class="pers"> job postuler  </a>

            </div>
            <div class="perspar">
            <a href="" class="pers"> job selected  </a>
    ...
    <div class="contenaire">
        ...
        <table class="" cellspacing="0">
          <th class="">
           ...
           <?php 
           $re=mysqli_query($conn,"SELECT * FROM selected where idselecte =$id");
